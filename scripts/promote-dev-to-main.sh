...
DEV_BRANCH="${1:-dev}"
FRONT_VERSION_FILE="$ROOT_DIR/opa-finance-front/src/generated/app-version.ts"
API_VERSION_FILE="$ROOT_DIR/opa-finance-api/src/generated/app-version.ts"
...
git add "$FRONT_VERSION_FILE" "$API_VERSION_FILE"
...
echo "  - arquivos de versao regenerados antes da tag"
echo
